...
1. Clone este repositório em sua máquina local.
   ```bash
   git clone https://github.com/seu-usuario/seu-projeto.git](https://github.com/hellen-moura/calculadora-IMC.git)https://github.com/hellen-moura/calculadora-IMC.git
